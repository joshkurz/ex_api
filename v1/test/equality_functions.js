...
(function() {
  var activitiesShouldBeEqual, addressesShouldBeEqual, companiesShouldBeEqual, contactsShouldBeEqual, customersShouldBeEqual, invoicesShouldBeEqual, performedWorkShouldBeEqual, should, usersShouldBeEqual;
  ...
  addressesShouldBeEqual = function(address1, address2) {
    ...
    return should.equal(address1.country, address2.country);
  };
  ...
  contactsShouldBeEqual = function(contact1, contact2) {
    ...
    if (contact1 !== null) {
      should.exist(contact2);
    }
    if (contact2 !== null) {
      should.exist(contact1);
    }
    should.equal(contact1.name, contact2.name);
    return should.equal(contact1.email, contact2.email);
  };
  ...
  customersShouldBeEqual = function(customer1, customer2) {
    ...
    return contactsShouldBeEqual(customer1.contact, customer2.contact);
  };
  ...
  activitiesShouldBeEqual = function(activity1, activity2) {
    ...
    return performedWorkShouldBeEqual(activity1.performedWork, activity2.performedWork);
  };
  ...
  companiesShouldBeEqual = function(company1, company2) {
    ...
    return addressesShouldBeEqual(company1.address, company2.address);
  };
  ...
  invoicesShouldBeEqual = function(invoice1, invoice2) {
    ...
    return should.equal(invoice1.totalIncludingVat.toFixed(), invoice2.totalIncludingVat.toFixed());
  };
  ...
  usersShouldBeEqual = function(user1, user2) {
    ...
    return should.equal(user1.passwdHash, user2.passwdHash);
  };
